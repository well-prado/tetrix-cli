...
var configCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		display.AI.AnthropicAPIKey = redact(display.AI.AnthropicAPIKey)
		display.AI.VoyageAPIKey = redact(display.AI.VoyageAPIKey)
		display.AI.OpenAIAPIKey = redact(display.AI.OpenAIAPIKey)
		display.AI.GoogleAPIKey = redact(display.AI.GoogleAPIKey)
